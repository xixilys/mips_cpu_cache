...
withClockAndReset(clk.asClock,(~aresetn).asAsyncReset) {
    ...
    //length总共也就16，比较拉
    val tlb  = Module(new double_ports_tlb_for_inst_and_data(16)).io

    tlb.cp0_asid          := u_mips_cpu.cp0_asid
    ...
    icache_first.cp0_asid := u_mips_cpu.cp0_asid
    dcache_first.cp0_asid := u_mips_cpu.cp0_asid

    tlb.dcache_port.vaddr := Mux(u_mips_cpu.tlbp_search_en,u_mips_cpu.tlbp_search_vaddr,dcache_first.v_addr_for_tlb)
    ...
    dcache_first.data_wstrb := u_mips_cpu.data_wstrb
    ...
    icache_first.inst_buffer_empty := u_mips_cpu.inst_buffer_empty
    icache_first.inst_ready_branch := u_mips_cpu.inst_ready_branch
    icache_first.cp0_asid   := u_mips_cpu.cp0_asid
  ...
  //  u_mips_cpu.inst_cache_working_on := icache_first.cache_working_on    
    ...
    u_mips_cpu.data_stage2_stall := dcache_first.stage2_stall
    u_mips_cpu.inst_tlb_exception := icache_first.stage2_exception
    u_mips_cpu.data_tlb_exception := dcache_first.stage1_tlb_exception
    ...
    u_mips_cpu.tlb_search_hit  :=  tlb.tlb_search_hit
    //mem1 阶段扔进tlb数据   
    u_mips_cpu.tlb_search_index := tlb.tlb_search_index
    u_mips_cpu.cp0_tlb_write_data := tlb.tlb_read_port
    tlb.tlb_write_en     := u_mips_cpu.tlb_write_en
    tlb.tlb_write_port   := u_mips_cpu.cp0_tlb_read_data
    tlb.tlb_write_index  := u_mips_cpu.tlb_write_index
    tlb.tlb_read_index   := u_mips_cpu.tlb_read_index
